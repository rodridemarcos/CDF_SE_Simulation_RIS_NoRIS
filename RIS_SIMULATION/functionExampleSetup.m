...
for l = 1:L % Iterar sobre la celda propia (donde el UE está sirviendo)
    ...
    for k = 1:K
        ...
        PL = calculatePathLoss(scenario, frequency, distance_BS_UE_local, d_bp, hBS, hMS, 1); % Siempre LOS para ordenación
    ...
    for j = 1:L % Iterar sobre la BS desde la que se recibe (propia o interferente)
        ...
        for k = 1:K
            ...
            PL_BS_UE = calculatePathLoss(scenario, frequency, distancesBSj(k), d_bp, hBS, hMS, probLOS_BS_UE(k,l,j));
