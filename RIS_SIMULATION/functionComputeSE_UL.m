...
%
% ENTRADAS:
% Hhat              = Matriz M x nbrOfRealizations x K x L x L con las estimaciones
%                      de canal MMSE
% C                 = Matriz M x M x K x L x L con las matrices de correlación
%                      del error de estimación usando estimación MMSE
...
% N0                = Varianza del ruido (en Watts)
%
% SALIDAS:
% SE_MR      = Matriz K x L donde el elemento (k,l) es la SE UL del usuario k en
%              la celda l obtenida con combinación MR
...
% Calcular el factor pre-log (normalizado por el número de realizaciones del canal)
